...
#include <Arduino.h>
#endif
// On ESP32 (and any non-AVR C compilation), PROGMEM is a no-op
#ifndef PROGMEM
#define PROGMEM
#endif
...
// ---------------------------------------------- defines -----------------------------------------
#define DATA_BUFFER_SIZE                      4608  /**< max bytes for one frame: 48x32 = 1536 zones x 3 bytes */
#define ARDUINO_MAX_I2C_TRANSFER              128   /**< ESP32 Wire buffer supports up to 128 bytes in a single i2c tx/rx */

#define I2C_SDA_PIN                           21    /**< ESP32 SDA pin */
#define I2C_SCL_PIN                           22    /**< ESP32 SCL pin */

#define ENABLE_PIN                            5     /**< ESP32 enable pin connected to GPIO 5 */
#define INTERRUPT_PIN                         35    /**< ESP32 interrupt pin (input-only GPIO 35) */
...
#define TRIGGER_INTERRUPT_PIN                 35    /**< ESP32 interrupt pin */
